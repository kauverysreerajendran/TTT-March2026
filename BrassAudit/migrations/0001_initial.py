...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AQLSamplingPlan',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lot_qty_from', models.PositiveIntegerField(help_text='Starting lot quantity range')),
                ('lot_qty_to', models.PositiveIntegerField(help_text='Ending lot quantity range')),
                ('sample_qty', models.PositiveIntegerField(help_text='Number of items to sample')),
                ('aql_limit', models.DecimalField(decimal_places=2, help_text='AQL limit value', max_digits=4)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Brass_Audit_Rejection_Table',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            name='Brass_Audit_Accepted_TrayID_Store',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lot_id', models.CharField(blank=True, help_text='Lot ID', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            name='Brass_Audit_Accepted_TrayScan',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lot_id', models.CharField(blank=True, help_text='Lot ID', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            name='Brass_Audit_Rejection_ReasonStore',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lot_id', models.CharField(blank=True, help_text='Lot ID', max_length=50, null=True)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('rejection_reason', models.ManyToManyField(blank=True, to='BrassAudit.brass_audit_rejection_table')),
            ],
        ),
        migrations.CreateModel(
            name='Brass_Audit_Rejected_TrayScan',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lot_id', models.CharField(blank=True, help_text='Lot ID', max_length=50, null=True)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('rejection_reason', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BrassAudit.brass_audit_rejection_table')),
            ],
        ),
        migrations.CreateModel(
            name='Brass_Audit_TopTray_Draft_Store',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lot_id', models.CharField(max_length=255)),
                ('batch_id', models.CharField(max_length=255)),
